...
class ProductionConfig(Config):
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL')# + "?charset=utf-8" # or 'sqlite:///' + os.path.join(basedir, 'AutoLine.sqlite')
    #SQLALCHEMY_ECHO = True
    TRIGGER_DATABASE_URL = os.environ.get('TRIGGER_DATABASE_URL')# + "?charset=utf-8"
